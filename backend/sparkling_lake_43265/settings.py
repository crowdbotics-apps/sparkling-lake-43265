"""
Django settings for sparkling_lake_43265 project.
...
ROOT_URLCONF = 'sparkling_lake_43265.urls'
...
WSGI_APPLICATION = 'sparkling_lake_43265.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparkling_lake_43265 API",
    "DESCRIPTION": "API documentation for sparkling_lake_43265 App",
    "VERSION": "v1",
}

...
## Project Structure
    ...
    ├── sparkling_lake_43265  # Django project configurations
...
1. Clone this repo and `cd sparkling_lake_43265`
...
2. Clone this repo and `cd sparkling_lake_43265`
